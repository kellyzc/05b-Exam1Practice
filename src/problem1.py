...
def run_test_problem1a():
    ...
    # Test 3
    expected = 1.13508592438551717278  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4
    expected = 0.06332106241393484488  # This is APPROXIMATELY the correct answer.
...
def run_test_problem1b():
    ...
    print('--------------------------------------------------')
    expected = [4, 6, 6, 8]
    actual = [problem1b(2, 4), problem1b(4, 5), problem1b(3, 6), problem1b(5, 6)]
    for i in range(4):
